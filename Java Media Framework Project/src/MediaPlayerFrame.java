...
import net.sourceforge.jffmpeg.codecs.audio.mpeg.mp3.*;
import java.io.*;
    ...
    public static void main(String[] args) {
        try {
            if (true) {
                ...
                */
                //mpf.setMediaLocator(new MediaLocator("rtp://192.168.1.83:40250/audio"));
                ...
                */
                ...
                mpf.setMediaLocator(new MediaLocator(
                    new File("src/Grand Theft Auto San Andreas Theme.mp3").toURI().toURL()));
                mpf.show();
            } else {
                printUsage();
            }
